...
{
	AnalogInputReadSingle(LDRinput_4.input, &valor1);
	AnalogInputReadSingle(LDRinput_2.input, &valor2);
	AnalogInputReadSingle(LDRinput_3.input, &valor3);
	AnalogInputReadSingle(LDRinput_4.input, &valor4);
